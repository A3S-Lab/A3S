...
- Visible task execution mode with a mode-specific icon, provider-tabbed model
  ...
  before the initial API round trip completes. Once execution begins, the
  panel continues to show only real plans and subagent lifecycle events.
  Dedicated Use workers are
