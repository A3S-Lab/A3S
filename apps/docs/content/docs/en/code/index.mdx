---
title: "A3S Code"
description: "Harness-driven coding agent runtime with the v3.1.0 SDKs"
---

# A3S Code

A3S Code v3.1.0 is a harness-driven runtime for coding agents. The runtime keeps the agent loop small and observable while the harness owns context assembly, tool execution, permission policy, delegation, verification evidence, and run replay.
