...
A host can connect them to managed sessions, open-platform APIs, AHP, MCP,
...
| Markdown skills | [Skills](/docs/code/skills) | File skills, inline skills, and built-in skills share discovery semantics. |
...
- `activeTools()` for the visible tool surface.
