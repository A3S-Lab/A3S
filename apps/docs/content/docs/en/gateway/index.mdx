...
- Gradual rollout — step-by-step traffic shift with auto-rollback on error rate or latency (implemented and validated; not yet driven at runtime in v1.0.7)
...
- Current release: **v1.0.7** (MSRV Rust 1.88); published Linux images/binaries enable the `kube` + `redis` features
