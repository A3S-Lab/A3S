---
title: Quick Start
description: Install A3S Gateway (v1.0.7) and run a minimal reverse proxy to an LLM/HTTP backend
---

# Quick Start

This guide gets A3S Gateway **v1.0.7** running as a reverse proxy in front of an
