...
`DetailPanel`, `Timeline`, and `SectionHeader`; live and completed tool output
and task summaries use `ConnectorBlock`; file-edit diffs use `DiffView`;
...
uses `SessionStatus` plus `ModeLine`. Menu bounds, selection windows, connector
