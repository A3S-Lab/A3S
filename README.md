...
click-to-apply, `/effort` wheel/click adjustment, `@` file picker wheel
browsing and click-to-insert, `/plugin` wheel browsing and click-to-toggle,
...
`/effort` slider hit-testing, `/theme` preview hit-testing, `@` file picker
hit-testing, `/plugin` overlay hit-testing, footer context meters, and footer
